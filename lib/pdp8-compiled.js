        ...
        ADD: function ADD(pdp8_obj) {
            ...
            // MBR <- M
                ...
                // E-AC <- AC + MBR
                        ...
                        var tmp = pdp8_obj.registers.AC + pdp8_obj.registers.MBR;
                        var tmp_e = 0;
                        if (to_base_2(pdp8_obj.registers.AC, 16)[0] === '1' && to_base_2(pdp8_obj.registers.MBR, 16)[0] === '1' && to_base_2(tmp, 16)[0] === '0' || to_base_2(pdp8_obj.registers.AC, 16)[0] === '0' && to_base_2(pdp8_obj.registers.MBR, 16)[0] === '0' && to_base_2(tmp, 16)[0] === '1') {
                            tmp_e = 1;
                        }
                        pdp8_obj.registers.AC = tmp & 65535;
