    ...
    const exec = {
        ...
        ADD: (pdp8_obj) => {
            ...
            // E-AC <- AC + MBR
                ...
                let tmp_e = 0;
                if ((to_base_2(pdp8_obj.registers.AC, 16)[0] === '1' && to_base_2(pdp8_obj.registers.MBR, 16)[0] === '1' && to_base_2(tmp, 16)[0] === '0') ||
                     (to_base_2(pdp8_obj.registers.AC, 16)[0] === '0' && to_base_2(pdp8_obj.registers.MBR, 16)[0] === '0' && to_base_2(tmp, 16)[0] === '1')) {
                    tmp_e = 1;
                }
                pdp8_obj.registers.AC = tmp & 0b1111111111111111;
                pdp8_obj.registers.E = tmp_e;
